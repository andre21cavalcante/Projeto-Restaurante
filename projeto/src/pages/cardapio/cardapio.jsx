    ...
    <div>
        ...
        <Container>
            <div>  
                ...
                <p className={styles.NomeComida}>Preço:R$ 100,00</p>
            </div>
            <div>  
                <Image src={frango}/>
                <p className={styles.NomeComida}>NotChiken</p>
                <p className={styles.NomeComida}>Preço:R$ 20,00</p>
            </div>
            <div>
                <Image src={Espaguete}/>
                <p className={styles.NomeComida}>Espaguete</p>
                <p className={styles.NomeComida}>Preço:R$ 30,00</p>
            </div>
            <div>
                <Image src={macarrao}/>
                <p className={styles.NomeComida}>Macarrão Vegetariano</p>.
                <p className={styles.NomeComida}>Preço:R$ 25,00</p>
            </div>
            <div>
                <Image src={taco}/>
                <p className={styles.NomeComida}>Taco Vegetariano</p>
                <p className={styles.NomeComida}>Preço:R$ 15,00</p>
            </div>
            <div>
                <Image src={salmao}/>
                <p className={styles.NomeComida}>Moqueca de Salmón</p>
                <p className={styles.NomeComida}>Preço:R$ 55,00</p>
            </div>
            <div>
                <Image src={Camarao}/>
                <p className={styles.NomeComida}>Camarão com Torrada</p>
                <p className={styles.NomeComida}>Preço:R$ 10,00</p>
            </div>
            <div>
                <Image src={mini}/>
                <p className={styles.NomeComida}>MiniBurguer</p>
                <p className={styles.NomeComida}>Preço:R$ 8,00</p>
            </div>
            <div>
                <Image src={Morango}/>
                <p className={styles.NomeComida}>Iogurte de Morango</p>
                <p className={styles.NomeComida}>Preço:R$ 5,00</p>
            </div>
            <div>
                <Image src={Oreo}/>
            ...
            <div>
                ...
                <p className={styles.NomeComida}>Preço:R$ 6,00</p>
            </div>
            <div>
                <Image src={Donuts}/>
